// TEMPORARY one-shot digest. Emails James the most recent pricing-interest
// events once, then marks itself done so it never re-sends (no inbox flood).
// Remove this file after the email has arrived.
