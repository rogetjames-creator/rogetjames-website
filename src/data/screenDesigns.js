...
export const SCREEN_DESIGNS = [
  ...
  ] },
  {
    ...
    items: [
      ...
      { name: "ERGO — Residential",  img: "/images/ergo/ergo-residential.jpg", description: "ERGO residential entrance gates and screen panels", tags: ["fencing", "residential"] },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "EROS Pool Compliant", img: `${CDN}/b4e3f929-4c8f-433b-a535-3500ca5058a3_rw_1200.jpg`, tags: ["residential"] },
  ...
  { name: "PANGEA",  items: [{ name: "PANGEA",  img: `${CDN}/59a1ba1e-dc20-4f20-a4bf-b0a9d7a13a34_rw_1920.jpg`, tags: ["divider", "commercial"] }] },
  {
    ...
    items: [
      ...
      { name: "VUELTA",              img: `${CDN}/c9cc882b-cd1b-4ea9-964a-3b0cddd3cb65_rw_1200.jpg`, tags: ["gates", "residential"] },
