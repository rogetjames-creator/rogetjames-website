...
// FROZEN SNAPSHOT of the original "Art meets design" hero (animated ROJ logo +
// crossfading slideshow), kept as-is so it survives once the live Hero.jsx is
// replaced. Rendered only on the private /hero admin preview. Edit this file to
// work up the new hero; when James says go, it gets promoted into Hero.jsx.
// This is a byte-for-byte copy of Hero.jsx at the time the preview was created —
// keep it independent of the live hero.
