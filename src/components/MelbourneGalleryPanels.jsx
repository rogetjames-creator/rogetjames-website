...
// vertically, reading bottom→top. Placement: below the intro spiel on the
// Melbourne page (replaces the old "Pieces in Melbourne" grid).
// Images are representative placeholders — swap freely. Concrete has no gallery
// yet, so it's a dark panel that just points at the Bespoke section for now.
const PANELS = [
          ...
          {PANELS.map((p, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Gallery name — vertical, reading bottom→top, anchored low */}
                <div className="absolute inset-0 flex items-end justify-center pb-7 pointer-events-none">
                  <span
                    className="font-detail uppercase text-cream whitespace-nowrap"
                    style={{
                      writingMode: "vertical-rl",
                      transform: "rotate(180deg)",
                      letterSpacing: "0.28em",
                      fontSize: active ? 17 : 12.5,
