        ...
        <div ref={cardsRef} className="grid md:grid-cols-3 gap-4 md:gap-6 max-w-5xl mx-auto">
          {SERVICES.map((service) => {
            ...
            return (
              <div
                key={service.title}
                className="service-card group bg-black border border-white/25 hover:border-white/50 rounded-[2rem] p-5 md:p-8 lg:p-10 flex flex-col transition-all duration-500"
              ...
              >
                ...
                <h3 className="font-heading font-bold text-xl md:text-2xl mb-3 text-cream/45 transition-colors duration-500 group-hover:text-cream/60">
