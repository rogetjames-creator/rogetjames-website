...
.fw-title{font-weight:800;line-height:.94;letter-spacing:-.01em;font-size:clamp(28px,4vw,58px);text-transform:uppercase;color:rgba(242,240,233,.2) !important;text-shadow:0 2px 10px rgba(0,0,0,.3)}
...
function Gallery() {
  ...
  // Title always breaks after the first word rather than wrapping wherever
  // the container width happens to allow.
...
export default function SculptureWall() {
  ...
  useEffect(() => {
    ...
    if (urlKey) window.history.replaceState({}, "", "/feature-sculpture");
        ...
        <div className="w-full max-w-sm">
          <div className="bg-white/8 border border-white/18 rounded-[2rem] p-8">
            <div className="text-center mb-8">
              ...
              <p className="font-detail text-[10px] text-cream/85 uppercase tracking-[0.25em]">Feature Sculpture — Private</p>
            </div>
