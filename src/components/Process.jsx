        ...
        <div ref={cardsRef} className="flex flex-col gap-3 max-w-3xl mx-auto">
          {STEPS.map((step) => {
            ...
            return (
              <div
                key={step.num}
                className="process-card group w-full bg-black rounded-[2rem] border border-white/10 px-8 py-4 flex flex-col items-center text-center gap-2 hover:border-white/20 hover:bg-white/5 transition-all duration-500"
