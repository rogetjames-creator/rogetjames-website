        ...
        <div ref={cardsRef} className="flex flex-col gap-3 max-w-3xl mx-auto">
          {STEPS.map((step) => {
            ...
            return (
              <div
                key={step.num}
                className="process-card group w-full bg-black rounded-[2rem] border border-white/25 px-8 py-4 flex flex-col items-center text-center gap-2 hover:border-white/50 transition-all duration-500"
              ...
              >
                ...
                {/* Title */}
                <h3 className="font-heading font-bold text-lg text-cream opacity-55 mt-1 transition-opacity duration-500 group-hover:opacity-100">
