        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <div className="relative ml-1">
            <a
              ...
              style={{ background: "#443d2a", boxShadow: "inset 0 1.5px 0 rgba(255,255,255,0.18), inset 0 -1.5px 0 rgba(0,0,0,0.45), 0 1px 4px rgba(0,0,0,0.35)", transition: "box-shadow 0.1s ease, transform 0.1s ease" }}
