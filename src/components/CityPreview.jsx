...
// the shared CityPage template. One thin entry per city passes its data:
//   <CityPreview city={PERTH} label="Perth Page — Private Preview" slug="/perth" />
export default function CityPreview({ city, label, slug }) {
        ...
        <div className="w-full max-w-sm">
          <div className="bg-white/8 border border-white/18 rounded-[2rem] p-8">
            <div className="text-center mb-8">
              ...
              <p className="font-detail text-[10px] text-cream/85 uppercase tracking-[0.25em]">{label}</p>
            </div>
